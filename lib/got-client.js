...
const GitReader = require('./GitReader.js')
...
class Client {
  ...
  constructor (){
    ...
    this.gitReader = new GitReader("master")
  }


  async addRepo(){
    try{
        console.log("sending this repo:", this.gitReader.getRepo())
        let newRepoString = JSON.stringify(this.gitReader.getRepo());
  ...
  async queryRepo(){
    try{
        let response = await contract.evaluateTransaction('queryRepo', this.gitReader.getAuthor(), this.gitReader.getName())
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async cloneRepo(){
    try{
        let response = await contract.evaluateTransaction('clone', this.gitReader.getAuthor(), this.gitReader.getName())
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async addBranch(branchName){
    try{
        let newBranchString = JSON.stringify(this.gitReader.getBranch(branchName));
        let response = await contract.submitTransaction('addNewBranch', this.gitReader.getAuthor(), this.gitReader.getName(), newBranchString)
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async queryBranches(){
    try{
        let response = await contract.evaluateTransaction('queryBranches', this.gitReader.getAuthor(), this.gitReader.getName())
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async queryBranch(branchName){
    try{
        let response = await contract.evaluateTransaction('queryBranch', this.gitReader.getAuthor(), this.gitReader.getName(), branchName)
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async queryBranchCommits(branchName, lastCommit){
    try{
        let response = await contract.evaluateTransaction('queryBranchCommits', this.gitReader.getAuthor(), this.gitReader.getName(), branchName, lastCommit)
        console.log("Submit Response=",response.toString())
    } catch(e){
        console.log(e)
    }
  ...
  async queryLastBranchCommit(branchName){
    try{
        let response = await contract.evaluateTransaction('queryLastBranchCommit', this.gitReader.getAuthor(), this.gitReader.getName(), branchName)
        console.log("Submit Response=",response.toString())
  ...
  async loadCurrentRepo(){
    await this.gitReader.loadCurrentRepo()
  }
  ...
  async updateRemote(){
    ...
    var lastCommit = await this.queryLastBranchCommit(this.gitReader.getCurrentBranchName());
    var fileName = '.got/refs/heads/' + this.gitReader.getCurrentBranchName();
  ...
  async push(){
    ...
    await this.remotePostReceive(this.gitReader.getCurrentBranchName());
  }
