...
class User{
    ...
    signMessage(content){
        ...
        signedData.messageNumber = this.lastMessageNumber
        this.lastMessageNumber = this.lastMessageNumber + 1
    ...
    createNewUserMessage(userName, publicKey = null, privateKey = null){
        ...
        userUpdate.userInfo = this.userInfo
    ...
    changeUserNameMessage(userName){
        ...
        userUpdate.userInfo = this.userInfo
        userUpdate.userInfo.userName = userName
    ...
    generateNewKeysMessage(publicKey = null, privateKey = null){        
        ...
        // create the message to be sent to hyperledger
        var userUpdate = {}
        userUpdate.userUpdateType = UserUpdateType.changeUserNameMessage
        userUpdate.userInfo = this.userInfo
        userUpdate.oldUserName = ""
    ...
    removeUserMessage(){        
        // create the message to be sent to hyperledger
        var userUpdate = {}
        userUpdate.userUpdateType = UserUpdateType.removeUserMessage
        userUpdate.userInfo = this.userInfo
        userUpdate.oldUserName = ""
